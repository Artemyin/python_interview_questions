...
```python
In [51]: 10 in dict.values()
Out[51]: True

# look for a value
In [52]: [10 in x for x in dict.items()]
Out[52]: [False, False, False, False, False, False, True, False, False]

# look for a key
In [53]: ['exp' in x for x in dict.items()]
Out[53]: [False, False, False, False, False, False, True, False, False]
any()
```
